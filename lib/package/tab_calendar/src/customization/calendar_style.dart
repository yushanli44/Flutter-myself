...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.weekendStyle = const TextStyle(color: Color(0xFFF44336)), // Material red[500]
    this.holidayStyle = const TextStyle(color: Color(0xFFB00020)), // Error
    this.selectedStyle = const TextStyle(color: Color(0xFFFAFAFA), fontSize: 16.0), // Material grey[50]
    this.outsideStyle = const TextStyle(color: Color(0xFF9E9E9E)), // Material grey[500]
    this.outsideWeekendStyle = const TextStyle(color: Color(0xFFEF9A9A)), // Material red[200]
    this.outsideHolidayStyle = const TextStyle(color: Color(0xFFEF9A9A)), // Material red[200]
    this.unavailableStyle = const TextStyle(color: Color(0xFFBFBFBF)),
    this.selectedColor = const Color(0xFF5C6BC0), // Material indigo[200]
    ...
    this.markersPositionBottom = 12.0,
    this.markersPositionLeft,
    this.markersPositionRight,
    this.markersMaxAmount = 5,
