  ...
  static void showDatePicker(
    ...
    Navigator.push(
        ...
        _DatePickerRoute(
            ...
            pickerModel:
                DatePickerModel(currentTime: currentTime, maxTime: maxTime, minTime: minTime, locale: locale)));
  }
...
class _DatePickerComponent extends StatefulWidget {
  const _DatePickerComponent({@required this.route, this.onChanged, this.locale, this.pickerModel});
  ...
  Widget _renderItemView(DatePickerTheme theme) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _renderColumnView(ValueKey(widget.pickerModel.currentLeftIndex()), theme,
              widget.pickerModel.leftStringAtIndex, leftScrollCtrl, widget.pickerModel.layoutProportions()[0], (index) {
