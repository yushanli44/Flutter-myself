...
String formatDate(DateTime date, List<String> formats, LocaleType locale) {
  ...
  for (String format in formats) {
    if (format == yyyy) {
      ...
      final String monthLong = i18nObjInLocale(locale)['monthLong'][date.month - 1] as String;
      sb.write(monthLong);
    } else if (format == M) {
      final String monthShort = i18nObjInLocale(locale)['monthShort'][date.month - 1] as String;
      sb.write(monthShort);
    } else if (format == dd) {
      ...
      String day = i18nObjInLocale(locale)['day'][date.weekday - 1] as String;
